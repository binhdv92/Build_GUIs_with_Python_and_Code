...
class MyWindow(Gtk.Window):
    ...
    def init_ui(self):    
        ...
        self.bardejov = GdkPixbuf.Pixbuf.new_from_file("alpha1.jpg")
        self.rotunda = GdkPixbuf.Pixbuf.new_from_file("alpha2.jpg")
        self.mincol = GdkPixbuf.Pixbuf.new_from_file("alpha3.jpg")
